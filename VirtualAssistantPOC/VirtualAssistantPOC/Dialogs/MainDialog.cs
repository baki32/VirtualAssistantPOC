...
using SwissReAssistantPOC.Models;
using SwissReAssistantPOC.Services;

namespace SwissReAssistantPOC.Dialogs
{
    ...
    public class MainDialog : ComponentDialog
    {
            ...
            : base(nameof(MainDialog))
        {
            ...
            foreach (var knowledgebase in localizedServices.QnAConfiguration)
            {
                var qnaDialog = new QnAMakerDialog(
                    ...
                    noAnswer: MessageFactory.Text("Not supported"),//_templateEngine.GenerateActivityForLocale("UnsupportedMessage"),
                    activeLearningCardTitle: "QnaMakerAdaptiveLearningCardTitle",// _templateEngine.GenerateActivityForLocale("QnaMakerAdaptiveLearningCardTitle").Text,
                    cardNoMatchText: "No QnA match")
                {
        ...
        private async Task<DialogTurnResult> IntroStepAsync(WaterfallStepContext stepContext, CancellationToken cancellationToken)
        {
            ...
            {
                Prompt = stepContext.Options as Activity ?? MessageFactory.Text("What can I help you with today?")
            };
        ...
        private async Task<DialogTurnResult> FinalStepAsync(WaterfallStepContext stepContext, CancellationToken cancellationToken)
        {
            ...
            return await stepContext.ReplaceDialogAsync(InitialDialogId, MessageFactory.Text("I’m here if you need anything else."), cancellationToken);
        }
