...
using SwissReAssistantPOC.Adapters;
using SwissReAssistantPOC.Authentication;
using SwissReAssistantPOC.Bots;
using SwissReAssistantPOC.Dialogs;
using SwissReAssistantPOC.Services;

namespace SwissReAssistantPOC
{
